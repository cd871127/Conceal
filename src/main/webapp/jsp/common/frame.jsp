            ...
            <li class="dropdown"><a href="#" class="dropdown-toggle dker" data-toggle="dropdown"> <i
                ...
                <section class="dropdown-menu aside-xl on animated fadeInLeft no-borders lt">
                    <div class="wrapper lter m-t-n-xs"><a href="#" class="thumb pull-left m-r"> <img
                        ...
                        <div class="clear"><a href="#"><span class="text-white font-bold">@Mike Mcalidek</span></a>
                        ...
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0"
                            ...
                            <nav class="nav-primary hidden-xs">
                                <ul class="nav">
                                    ...
                                    <li class="active"><a href="#uikit" class="active"> <i class="fa fa-flask icon"> <b
                                            class="bg-success"></b> </i> <span class="pull-right"> <i
